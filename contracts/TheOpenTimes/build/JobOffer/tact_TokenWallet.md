...
Signature: `Approve{amount:coins}`
...
Signature: `ContractData{title:^string,description:^string,price:uint64,owner:address,doer:Maybe address,is_locked:bool,state:uint32,jetton_master:address,balance:coins,my_jetton_address:address}`
...
3426: Offer could be revoked only by owner.
4429: Invalid sender
6344: Price and deposit did not equal
22085: Poster could not pick up job
26846: Job already got
51333: Could not on this stage.
51724: Invalid ton amount
54227: Invalid token amount
63855: Only platform method