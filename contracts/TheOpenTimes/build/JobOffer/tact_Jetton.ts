...
export function loadMint(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 1187350926) { throw Error('Invalid prefix'); }
    let _receiver = sc_0.loadAddress();
    let _amount = sc_0.loadIntBig(257);
    return { $$type: 'Mint' as const, receiver: _receiver, amount: _amount };
}
...
export function loadContractData(slice: Slice) {
    ...
    return { $$type: 'ContractData' as const, title: _title, description: _description, price: _price, owner: _owner, doer: _doer, is_locked: _is_locked };
}
...
async function Jetton_init(owner: Address, content: Cell) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initJetton_init_args({ $$type: 'Jetton_init_args', owner, content })(builder);
...
const Jetton_errors: { [key: number]: { message: string } } = {
    ...
    35717: { message: `Offer could be revoked only by poster.` },
    42708: { message: `Invalid sender!` },
    43422: { message: `Invalid value - Burn` },
    53266: { message: `Offer already locked. ` },
...
const Jetton_types: ABIType[] = [
    ...
    {"name":"Mint","header":1187350926,"fields":[{"name":"receiver","type":{"kind":"simple","type":"address","optional":false}},{"name":"amount","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
...
export class Jetton implements Contract {
    ...
    static async init(owner: Address, content: Cell) {
        return await Jetton_init(owner, content);
    }
    
    static async fromInit(owner: Address, content: Cell) {
        const init = await Jetton_init(owner, content);
