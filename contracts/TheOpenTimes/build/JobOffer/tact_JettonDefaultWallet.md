...
## Mint
TLB: `mint#46c5898e receiver:address amount:int257 = Mint`
Signature: `Mint{receiver:address,amount:int257}`
...
Signature: `ChangeStatus{status:uint32}`

## JobOfferCloseState
TLB: `_ doer:bool owner:bool = JobOfferCloseState`
Signature: `JobOfferCloseState{doer:bool,owner:bool}`

## ContractData
TLB: `_ title:^string description:^string price:uint64 owner:address doer:Maybe address is_locked:bool = ContractData`
Signature: `ContractData{title:^string,description:^string,price:uint64,owner:address,doer:Maybe address,is_locked:bool}`
...
22085: Poster could not pick up job
23951: Insufficient gas
26846: Job already got
35717: Offer could be revoked only by poster.
42708: Invalid sender!
43422: Invalid value - Burn
53266: Offer already locked.
